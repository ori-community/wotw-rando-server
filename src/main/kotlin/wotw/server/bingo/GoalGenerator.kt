...
//        threshold("Windtorn Ruins", 10289, 19890, 3, hideValue=true, countOnly = true),
    ...
    group(
        ...
        bool("Central Pools", 945, 58183),
        bool("Pools Boss", 945, 1370),
...
//        threshold("The Silent Map", 14019, 24683, 5, hideValue = true),
    ...
    group(
        ...
        bool("Above Central Pools TP HC", 5377, 63201),
        ...
        bool("EX above Opher in Marsh", 21786, 50255),
        ...
        bool("Pools Bubble Room EC", 5377, 1600),
        bool("Ruins Revisit EC", 10289, 44555),
        bool("Pools Entrance Ore", 5377, 34852),
    ...
    bool("Break the log in Marsh", 21786, 59922),
